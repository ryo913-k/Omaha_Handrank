...
from utils import SimpleCard, normalize_input_text, render_hand_html, render_card_selector, set_input_callback

# ==========================
# Part 1: Preflop Analysis
# ==========================
def render_plo_preflop(df_plo):
    if df_plo is None:
    ...
    with st.sidebar:
        ...
        with st.expander("2. 🔍 Hand Rank", expanded=False):
            ...
            with c_rk1: srk = st.number_input("Rank", 1, len(df_plo), 1, key="prk_plo", label_visibility="collapsed")
            with c_rk2:
...
# ==========================
# Part 2: Postflop Analysis (Board Analyzer)
# ==========================
...
def render_plo_postflop(df_plo):
